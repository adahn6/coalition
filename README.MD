...
Coalition is a fast, high-power multiplayer format about leading creature coalitions into battle. Choose a legendary creature as the coalition's **leader**, then build a 60-card deck plus sideboard around one of its creature type **affiliations.**
