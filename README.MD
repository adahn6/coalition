...
Coalition is a fast, high-power multiplayer format about leading creature coalitions into battle. Choose a legendary creature as the coalition's **leader**, then build a 60-card deck plus sideboard around one of its creature type **affiliations [^1].**
...
[^1] Affiliation describes what creature types a card is associated with. A card is affiliated with all creature types it is, as well as all creature types referenced in its Oracle text. See [Affiliation](#Affiliation)
