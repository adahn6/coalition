...
## Victory points
Each player starts the game at zero victory points, and earns victory points for all combat damage dealt to opponents. Players also earn victory points for all non-combat damage their coalition's leader deals to opponents. Any player who reaches 21 victory points immediately wins the game; and wining through any other means grants the winner 21 victory points. 
...
Coalition leaders may be referred to shorthand as just "leader".

For formal definitions of these actions and effects, please check the [comprehensive rules modification](RULES.MD)
> [!TIP] 
...
* General Play:
	...
	* **Match of 3 games**
  		...
  		* After each game, each player adds the victory points they had at the end of the game to their ranking
	...
	* **Coalition leaders aren't in the command zone**, they're outside the game. 
		* Once each turn, can place into hand. **No tax**!
  		* Can be returned to **outside the game** as replacement effets or SBAs
